...
namespace AutodeskRevitAPITrainingCreateModel1
{
    ...
    public class Main : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            List<Wall> walls = CreateWalls(doc, 15000, 6000, GetLevel(doc, "Уровень 1"), GetLevel(doc, "Уровень 2"));
        ...
        private void AddDoor(Document doc, Level level, Wall wall)
        {
            FamilySymbol doorType = new FilteredElementCollector(doc)
                ...
                .OfType<FamilySymbol>()
                .Where(x => x.Name.Equals("0915 x 2100 мм"))
